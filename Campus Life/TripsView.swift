...
struct TripsView: View {
    ...
    let zonas = ["Todas", "Panamá", "Bocas del Toro", "San Blas", "Boquete", "Internacional"]
    let trips = Event.sampleEvents.filter { $0.category == .trips }
...
#Preview {
    NavigationStack { TripsView(searchText: "") }
}
