...
struct ActividadesView: View {
    ...
    let zonas = ["Todas", "Casco", "Amador", "Marbella", "Costa del Este", "Albrook"]
            ...
            VStack(spacing: 16) {
                ...
                VStack(spacing: 12) {
                    Text("🏄")
                        .font(.system(size: 50))
                        .padding(.top, 40)
                    Text("Actividades universitarias")
                        .font(.system(size: 18, weight: .bold))
                        .foregroundColor(.campusText)
                    Text("Talleres, deportes y actividades cerca de tu campus")
                        .font(.system(size: 14))
...
#Preview {
    NavigationStack { ActividadesView(searchText: "") }
}
